export default {
  ...
  keys: {
    ...
    modelMappingsConfig: "モデルマッピング設定",
  ...
  modelMappings: {
    ...
    totalMappings: "合計 {total} モデルマッピング",
    noModelMappings: "モデルマッピングがありません",
    loadFailed: "モデルマッピングの読み込みに失敗しました",
    removeModelMapping: "モデルマッピングを削除",
    confirmRemoveModelMapping: 'モデルマッピング "{model}" を削除してもよろしいですか？',
    editModelMapping: "モデルマッピングを編集",
    addTargetConfig: "ターゲット設定を追加",
    noMoreAvailableTargets: "利用可能なサブグループがありません",
    modelAliasRequired: "モデルエイリアスは必須です",
    modelAliasPlaceholder: "例：GPT-4",
    actualModelPlaceholder: "例：gpt-4-turbo",
    weightPlaceholder: "重みを入力",
    duplicateModelAlias: "モデルエイリアスは重複できません",
    atLeastOneTarget: "少なくとも一つのターゲットが必要です",
    duplicateTarget: "重複するサブグループを選択できません",
    invalidWeight: "無効な重みの値です",
    actualModelRequired: "実際のモデル名は必須です",
    targetsRequired: "少なくとも一つのターゲットを設定してください",
    targets: "ターゲット",
