export default {
  ...
  keys: {
    ...
    modelMappingsConfig: "Model Mappings Configuration",
  ...
  modelMappings: {
    ...
    addTargetConfig: "Add Target Configuration",
    noMoreAvailableTargets: "No more available sub groups",
    modelAliasRequired: "Model alias is required",
    modelAliasPlaceholder: "e.g., GPT-4",
    actualModelPlaceholder: "e.g., gpt-4-turbo",
    weightPlaceholder: "Enter weight",
    duplicateModelAlias: "Model alias cannot be duplicated",
    atLeastOneTarget: "At least one target is required",
    duplicateTarget: "Cannot select duplicate sub groups",
    invalidWeight: "Invalid weight value",
    actualModelRequired: "Actual model name is required",
    targetsRequired: "At least one target must be configured",
    targets: "targets",
