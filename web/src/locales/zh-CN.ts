export default {
  ...
  modelMappings: {
    ...
    addTargetConfig: "添加目标配置",
    noMoreAvailableTargets: "没有更多可用的子分组",
    modelAliasRequired: "请输入模型别名",
    modelAliasPlaceholder: "例如：GPT-4",
    actualModelPlaceholder: "例如：gpt-4-turbo",
    weightPlaceholder: "请输入权重",
    duplicateModelAlias: "模型别名不能重复",
    atLeastOneTarget: "至少需要一个目标配置",
    duplicateTarget: "不能选择重复的子分组",
    invalidWeight: "权重值无效",
    actualModelRequired: "请输入实际模型名称",
    targetsRequired: "请至少配置一个目标",
    targets: "目标",
    modelMapping: "模型映射",
    actualModelConfig: "实际模型配置",
    actualModelConfigTip: "可配置多个实际模型名称，支持负载均衡",
    addModel: "添加模型",
    addModelAlias: "添加别名",
