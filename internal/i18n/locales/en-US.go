...
var MessagesEnUS = map[string]string{
	...
	"validation.model_mapping_only_for_aggregate":            "Model mappings are only supported for aggregate groups",
	"validation.model_mapping_requires_sub_groups":           "Configure sub-groups before adding model mappings",
	"validation.model_mapping_alias_required":                "Model alias cannot be empty",
	"validation.model_mapping_duplicate_alias":               "Duplicate model alias {{.model}}",
	"validation.model_mapping_targets_required":              "Model alias {{.model}} must specify at least one target sub-group",
	"validation.model_mapping_duplicate_target":              "Model alias {{.model}} contains duplicate sub-group+actual model combinations",
	"validation.model_mapping_invalid_sub_group":             "Model alias {{.model}} references an unknown sub-group (ID {{.sub_group_id}})",
	"validation.model_mapping_invalid_weight":                "Model alias {{.model}} sets an invalid weight for sub-group {{.sub_group_id}}",
	"validation.model_mapping_target_model_required":         "Model alias {{.model}} requires specifying the actual upstream model",
