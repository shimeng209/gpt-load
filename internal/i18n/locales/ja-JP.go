...
var MessagesJaJP = map[string]string{
	...
	"validation.model_mapping_only_for_aggregate":            "モデルマッピングは集約グループでのみ利用可能です",
	"validation.model_mapping_requires_sub_groups":           "モデルマッピングを追加する前にサブグループを設定してください",
	"validation.model_mapping_alias_required":                "モデルエイリアスは必須です",
	"validation.model_mapping_duplicate_alias":               "モデルエイリアス {{.model}} が重複しています",
	"validation.model_mapping_targets_required":              "モデルエイリアス {{.model}} には少なくとも1つの対象サブグループが必要です",
	"validation.model_mapping_duplicate_target":              "モデルエイリアス {{.model}} に重複したサブグループ+実際モデルの組み合わせが含まれています",
	"validation.model_mapping_invalid_sub_group":             "モデルエイリアス {{.model}} が存在しないサブグループ (ID {{.sub_group_id}}) を参照しています",
	"validation.model_mapping_invalid_weight":                "モデルエイリアス {{.model}} のサブグループ {{.sub_group_id}} の重みが不正です",
	"validation.model_mapping_target_model_required":         "モデルエイリアス {{.model}} には実際のモデル名の指定が必要です",
