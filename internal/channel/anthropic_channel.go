...
func (ch *AnthropicChannel) ValidateKeyWithModel(ctx context.Context, apiKey *models.APIKey, group *models.Group, model string) (bool, error) {
...
func (ch *AnthropicChannel) validateWithSpecificModel(ctx context.Context, apiKey *models.APIKey, group *models.Group, model string) (bool, error) {
	upstreamURL := ch.getUpstreamURL()
	if upstreamURL == nil {
		return false, fmt.Errorf("no upstream URL configured for channel %s", ch.Name)
	}
...
func (ch *AnthropicChannel) validateWithDefaultModel(ctx context.Context, apiKey *models.APIKey, group *models.Group) (bool, error) {
	return ch.ValidateKey(ctx, apiKey, group)
}
